...
/* harmony import */ var _qr_code_qr_code_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./qr-code/qr-code.component */ "./src/app/qr-code/qr-code.component.ts");
...
var routes = [
    ...
    { path: 'qrcode', component: _qr_code_qr_code_component__WEBPACK_IMPORTED_MODULE_4__["QrCodeComponent"] },
    { path: '**', component: _qr_code_qr_code_component__WEBPACK_IMPORTED_MODULE_4__["QrCodeComponent"] }
];
...
/* harmony import */ var _qr_code_qr_code_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./qr-code/qr-code.component */ "./src/app/qr-code/qr-code.component.ts");
...
/* harmony import */ var ngx_moment__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ngx-moment */ "./node_modules/ngx-moment/esm5/ngx-moment.js");
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _qr_code_qr_code_component__WEBPACK_IMPORTED_MODULE_9__["QrCodeComponent"],
            ...
            imports: [
                ...
                ngx_moment__WEBPACK_IMPORTED_MODULE_12__["MomentModule"],
...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.login = function (email, password) {
        var _this = this;
        var url = "" + this.authUrlLogin;
        this.user = { email: email, password: password };
        return this.http.post(url, this.user, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(function (_) { return _this.log("fetched token"); }));
    };
    ;
    AuthService.prototype.register = function (fullName, email, password) {
        var _this = this;
        var url = "" + this.authUrlRegister;
        this.userRegister = { fullName: fullName, email: email, password: password };
        return this.http.post(url, this.userRegister, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(function (user) { return _this.log("User Registered"); }));
    };
    ;
    /*
...
module.exports = "\n<form align=\"center\" class=\"example-form\">\n  <br><br>\n  <mat-form-field class=\"full-width\">\n    <input matInput type=\"mail\" placeholder=\"Email\" [formControl]=\"email\">\n    <mat-error *ngIf=\"email.hasError('email') && !email.hasError('required')\">\n      Please enter a valid email address\n    </mat-error>\n    <mat-error *ngIf=\"email.hasError('required')\">\n      Email is <strong>required</strong>\n    </mat-error>\n  </mat-form-field>\n  <br><br>\n  <mat-form-field class=\"full-width\">\n    <input matInput type=\"password\" placeholder=\"Password\"\n      [formControl]=\"password\">\n    <mat-error *ngIf=\"password.hasError('required')\">\n      Password is <strong>required</strong>\n    </mat-error>\n  </mat-form-field>\n  <br>\n  <br>\n  <button mat-raised-button\n    [disabled]=\"!email.valid || !password.valid\" color=\"primary\"\n    (click)=\"login(email.value, password.value)\">Log</button>\n\n  <p>\n    \n    <ngb-alert *ngIf=\"successMessage\" type=\"success\" [dismissible]=\"false\" (close)=\"successMessage = null\">{{ successMessage }}</ngb-alert>\n    \n    <ngb-alert *ngIf=\"failMessage\" type=\"danger\" [dismissible]=\"false\"  (close)=\"failMessage = null\">{{ failMessage }}</ngb-alert>\n     \n  </p>\n\n</form>"
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(authService, sessionService, router) {
        this.authService = authService;
        this.sessionService = sessionService;
        this.router = router;
        this._success = new rxjs__WEBPACK_IMPORTED_MODULE_5__["Subject"]();
        this._fail = new rxjs__WEBPACK_IMPORTED_MODULE_5__["Subject"]();
    ...
    LoginComponent.prototype.ngOnInit = function () {
        ...
        this._success.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["debounceTime"])(3000)).subscribe(function () {
            _this.successMessage = null,
                _this.router.navigate(['qrcode']);
        });
        this._fail.subscribe(function (message) { return _this.failMessage = message; });
        this._fail.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["debounceTime"])(5000)).subscribe(function () { return _this.failMessage = null; });
    };
    LoginComponent.prototype.login = function (email, password) {
        var _this = this;
        this.authService.login(email, password)
            .subscribe(function (token) {
            _this.sessionService.setSession(token);
            _this._success.next("Connection success");
        }, function (error) {
            _this.errors = error;
            _this._fail.next("Connection failed");
        });
    };
    __decorate([
...
module.exports = "<br>\n<div align=\"center\">\n      <ngx-qrcode\n            [qrc-element-type]=\"'img'\"\n            [qrc-value]=\"value\"\n            qrc-class=\"aclass\"\n            qrc-errorCorrectionLevel=\"L\">\n      </ngx-qrcode>\n      <br>\n      <button mat-raised-button color=\"primary\" (click)=\"renderQR()\">Refresh !</button>\n</div>"
...
var QrCodeComponent = /** @class */ (function () {
    function QrCodeComponent(sessionService, router) {
        this.sessionService = sessionService;
        this.router = router;
        this.json = { email: '', unique: '' };
        this.value = '';
    ...
    QrCodeComponent.prototype.ngOnInit = function () {
        ...
        var decodedToken = helper.decodeToken(this.sessionService.getSession());
        this.json.email = decodedToken.email;
        // encoded Base 64
        this.renderQR();
    };
    QrCodeComponent.prototype.renderQR = function () {
    ...
    QrCodeComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_session_service__WEBPACK_IMPORTED_MODULE_3__["SessionService"],
            _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"]])
    ], QrCodeComponent);
...
var RegisterComponent = /** @class */ (function () {
    function RegisterComponent(authService) {
        ...
        this._fail = new rxjs__WEBPACK_IMPORTED_MODULE_3__["Subject"]();
    ...
    RegisterComponent.prototype.ngOnInit = function () {
        var _this = this;
        this._success.subscribe(function (message) { return _this.successMessage = message; });
        this._success.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["debounceTime"])(3000)).subscribe(function () {
            _this.successMessage = null;
            // this.router.navigate(['qrcode'])
        });
        this._fail.subscribe(function (message) { return _this.failMessage = message; });
        this._fail.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["debounceTime"])(5000)).subscribe(function () { return _this.failMessage = null; });
    };
    RegisterComponent.prototype.register = function (fullName, email, password) {
        var _this = this;
        console.log(fullName, email, password);
        this.authService.register(fullName, email, password)
            .subscribe(function (user) {
            //  this.sessionService.setSession(token);
            _this._success.next("User registered !");
        }, function (error) {
            _this.errors = error;
            _this._fail.next("Registration failed !");
        });
    };
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
...
var SessionService = /** @class */ (function () {
    ...
    SessionService.prototype.setSession = function (authResult) {
    ...
    SessionService.prototype.isLoggedOut = function () {
        return !this.isLoggedIn();
    };
    SessionService.prototype.getExpiration = function () {
...
module.exports = __webpack_require__(/*! /Users/clovis_olivier/workspace_new/nodejs/todoListApi/angular-src/src/main.ts */"./src/main.ts");
